...
set.seed(123)
trainset <- caret::createDataPartition(y = finalyear$fracinf, p = 0.7, list = FALSE)
data_train = finalyear[trainset,] #extract observations/rows for training, assign to new variable
data_test = finalyear[-trainset,] #do the same for the test set
```
