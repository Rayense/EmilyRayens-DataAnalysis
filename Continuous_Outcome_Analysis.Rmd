...
restaurant_settings <- subset(almost_there, Setting_1 == "restaurant" | Setting_1 == "Restaurant")
other_settings <- subset(almost_there, Setting_1 != "restaurant" & Setting_1 != "Restaurant")
...
str(final_draft)
ggplot(almost_there, aes(Setting_1, CasesAll)) + geom_point()
ggplot(final_draft, aes(Setting, CasesAll)) + geom_point()

sum(almost_there$CasesAll)
sum(final_draft$CasesAll)
if(sum(almost_there$RateAll) == sum(almost_there$RateAll))
  print("Done")
```
