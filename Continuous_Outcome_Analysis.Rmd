...
ggplot(final, aes(RiskAll, RateAll)) + geom_point()-> p1
ggplot(final, aes(MedianD1, RateAll)) + geom_point() -> p2
ggplot(final, aes(MeanD1, RateAll)) + geom_point() -> p3
ggplot(final, aes(Hospitalizations, RateAll)) + geom_point() -> p4
ggplot(final, aes(Vomit, RateAll)) + geom_point() -> p5
ggplot(final, aes(MeanI1, RateAll)) + geom_point() -> p6
ggplot(final, aes(MedianI1, RateAll)) + geom_point() -> p7
ggplot(final, aes(CasesAll, RateAll)) + geom_point() -> p8
ggplot(final, aes(Deaths, RateAll)) + geom_point() -> p9
ggplot(final, aes(OBYear, RateAll)) + geom_point() -> p9
